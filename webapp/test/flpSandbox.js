			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zaf2final-display": {
								"semanticObject": "zaf2final",
								"action": "display",
								"description": "FunnyBike AG Management Application für Fahrräder",
								"title": "FunnyBike",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zaf2final",
									"url": sap.ui.require.toUrl("zaf2final")
								}
							}
						}
					}
